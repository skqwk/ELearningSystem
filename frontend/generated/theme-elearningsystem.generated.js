...
import stylesCss from 'themes/elearningsystem/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_elearningsystem_componentCss']) {
    
    document['_vaadintheme_elearningsystem_componentCss'] = true;
  }
